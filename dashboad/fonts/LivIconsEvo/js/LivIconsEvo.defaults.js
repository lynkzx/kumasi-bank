/****************************************************************************************************
 * @name:        sEvo.defaults.js - the default options for  s (Live Icons) Evolution
...
if (typeof jQuery === 'undefined') {
  window.alert(' s Evolution Script requires jQuery (https://jquery.com)!');
  throw new Error(' s Evolution Script requires jQuery (https://jquery.com)!');
}


function  sEvoDefaults() {

  "use strict";

  var defaultOptions = {
    pathToFolder: assetBaseUrl + 'fonts/ sEvo/svg/', //the path from root of your site to folder with icons. Also may be as URL, like 'http://yoursite.com/path/to/ sEvo/svg/'
  ...
  if (defaultOptions.pathToFolder === '/EDIT THIS OPTION!/') {
    window.alert(' s Evolution: Please edit "pathToFolder" option in the " sEvo.defaults.js" file!');
    throw new Error(' s Evolution: Please edit "pathToFolder" option in the " sEvo.defaults.js" file!');
  }
